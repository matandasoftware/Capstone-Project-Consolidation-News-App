...
def main():
    """
    Handles the overall flow of the email application.

    It presents a menu to the user with options to read emails, view unread
    emails, or quit the application. Based on the user's input, the appropriate
    function is called to handle the selected action. The loop continues until
...
if __name__ == "__main__":
    # Ensures main() is only executed when script is run directly.
    # Prevents main() from running if module is imported elsewhere.
    main()
